...
<!-- Mirrored from htmlguru.net/house-rent/gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Jul 2022 20:15:50 GMT -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">                
                    ...
                    <p class="page-description">All gallery</p>        
                </div><!-- /.col-md-12 -->
            </div><!-- /.row-->
        </div><!-- /.container-fluid -->           
    </div><!-- /.page-header -->
	        ...
	        <div class="row">
	            <div class="col-md-3 col-sm-6 col-xs-6">
                    <div class="gallery-image-content">
                        <img src="assets/images/apartment/chakapicture/PHOTO-2022-07-22-15-35-19.jpg" alt="Chaka Resort" />
                        <div class="overlay-background gradient-transparent"> 
                            <a href="assets/images/apartment/chakapicture/PHOTO-2022-07-22-15-35-19.jpg" class="image-pop-up">
	            ...
	            <div class="col-md-3 col-sm-6 col-xs-6">
                    <div class="gallery-image-content">
                        <img src="assets/images/apartment/chakapicture/PHOTO-2022-07-22-15-35-18.jpg" alt="Chaka Resort" />
                        <div class="overlay-background gradient-transparent"> 
                            <a href="assets/images/apartment/chakapicture/PHOTO-2022-07-22-15-35-18.jpg" class="image-pop-up">
                                <span><i class="fa fa-picture-o"></i>Apartment</span>
                            </a><!-- /.hover-content -->
                        </div><!-- /.hover-content -->
                    </div><!-- /.image-content -->
	            ...
	            <div class="col-md-3 col-sm-6 col-xs-6">
                    <div class="gallery-image-content">
                        <img src="assets/images/apartment/chakapicture/PHOTO-2022-07-22-15-35-22.jpg" alt="Chaka Resort" />
                        <div class="overlay-background gradient-transparent"> 
                            <a href="assets/images/apartment/chakapicture/PHOTO-2022-07-22-15-35-22.jpg" alt="Chaka Resort" class="image-pop-up">
                                <span><i class="fa fa-picture-o"></i>Apartment</span>
                            </a><!-- /.hover-content -->
                        </div><!-- /.hover-content -->
                    </div><!-- /.image-content -->
	            ...
	            <div class="col-md-3 col-sm-6 col-xs-6">
                    <div class="gallery-image-content">
                        <img src="assets/images/apartment/honeylandbeach/575487271_WxH.jpg" alt="Honeyland Beach" />
                        <div class="overlay-background gradient-transparent"> 
                            <a href="assets/images/apartment/honeylandbeach/575487271_WxH.jpg" class="image-pop-up">
                                <span><i class="fa fa-picture-o"></i>Apartment</span>
                            </a><!-- /.hover-content -->
                        </div><!-- /.hover-content -->
                    </div><!-- /.image-content -->
	            ...
	            <div class="col-md-3 col-sm-6 col-xs-6">
                    <div class="gallery-image-content">
                        <img src="assets/images/apartment/honeylandbeach/Efi06inXoAAorcv.jpg" alt="Honeyland Beach" />
                        <div class="overlay-background gradient-transparent"> 
                            <a href="assets/images/apartment/honeylandbeach/Efi06inXoAAorcv.jpg" class="image-pop-up">
                                <span><i class="fa fa-picture-o"></i>Apartment</span>
                            </a><!-- /.hover-content -->
                        </div><!-- /.hover-content -->
                    </div><!-- /.image-content -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <div class="gallery-image-content">
                        <img src="assets/images/apartment/honeylandbeach/005f91bd_z.jpg" alt="Honeyland Beach" />
                        <div class="overlay-background gradient-transparent"> 
                            <a href="assets/images/apartment/honeylandbeach/005f91bd_z.jpg" class="image-pop-up">
                                <span><i class="fa fa-picture-o"></i>Apartment</span>
                            </a><!-- /.hover-content -->
                        </div><!-- /.hover-content -->
                    </div><!-- /.image-content -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <div class="gallery-image-content">
                        <img src="assets/images/apartment/jararesortbeach/La-Campagne-Tropicana.webp" alt="Jara Resort" />
                        <div class="overlay-background gradient-transparent"> 
                            <a href="assets/images/apartment/jararesortbeach/La-Campagne-Tropicana.webp" class="image-pop-up">
                                <span><i class="fa fa-picture-o"></i>Apartment</span>
                            </a><!-- /.hover-content -->
                        </div><!-- /.hover-content -->
                    </div><!-- /.image-content -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <div class="gallery-image-content">
                        <img src="assets/images/apartment/jararesortbeach/maxresdefault.jpg" alt="Jara Resort" />
                        <div class="overlay-background gradient-transparent"> 
                            <a href="assets/images/apartment/jararesortbeach/maxresdefault.jpg" class="image-pop-up">
                                <span><i class="fa fa-picture-o"></i>Apartment</span>
                            </a><!-- /.hover-content -->
                        </div><!-- /.hover-content -->
                    </div><!-- /.image-content -->
                ...
                <div class="clearfix"></div>
	             <div class="col-md-3 col-sm-6 col-xs-6">
                    <div class="gallery-image-content">
                        <img src="assets/images/apartment/jararesortbeach/jara-beach-resort.jpg" alt="Jara Resort" />
                        <div class="overlay-background gradient-transparent"> 
                            <a href="assets/images/apartment/jararesortbeach/jara-beach-resort.jpg" class="image-pop-up">
                                <span><i class="fa fa-picture-o"></i>Apartment</span>
                            </a><!-- /.hover-content -->
                        </div><!-- /.hover-content -->
                    </div><!-- /.image-content -->
