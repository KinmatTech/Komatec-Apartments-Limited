        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="heading-content-one border">
                        ...
                        <h5 class="sub-title">Find Your Rooms, for your availability</h5>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 col-xs-6">
                    <div class="apartments-content">
                        <div class="image-content">
                           <a href="booking.php"><img src="assets/images/apartment/chakapicture/PHOTO-2022-07-22-15-35-18.jpg" width="377" height="282" alt="Chaka Resort" /></a></a>
                        </div><!-- /.image-content -->
                   
                        <div class="text-content">
                            <div class="top-content">
                               <h3><a href="chakaresort.php">CHAKA RESORT</a></h3>
                               <span>
                                   <i class="fa fa-map-marker"> Eleko (Ibeju-Lekki) axis </i>
                            ...
                            <div class="bottom-content clearfix">
                               <div class="meta-bed-room">
                                   <i class="fa fa-bed"></i> <a href= "chakaresort.php"><strong>View Details</strong></a>
                               </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-6">
                    <div class="apartments-content">
                        <div class="image-content">
                            <a href="#"><img src="assets/images/apartment/honeylandbeach/575487271_WxH.jpg" width="377" height="282" alt="apartment" /></a>
                        </div><!-- /.image-content -->
                    
                        <div class="text-content">
                           <div class="top-content">
                               <h3><a href="honeyland.php">HONEYLAND RESORT</a></h3>
                               <span>
                                   <i class="fa fa-map-marker">  Musayo Beach, Eleko, Lotu Street </i>
                            ...
                            <div class="bottom-content clearfix">
                               <div class="meta-bed-room">
                                   <i class="fa fa-bed"></i> <a href= "honeyland.php"><strong>View Details</strong></a>
                               </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-6">
                    <div class="apartments-content">
                        <div class="image-content">
                            <a href="#"><img src="assets/images/apartment/jararesortbeach/La-Campagne-Tropicana.webp" width="377" height="282" alt="apartment" /></a>
                        </div><!-- /.image-content -->
                    
                        <div class="text-content">
                           <div class="top-content">
                               <h3><a href="jararesort.php">JARA RESORT BEACH</a></h3>
                               <span>
                                   <i class="fa fa-map-marker"> Lagos Lekki Ibeju Lekki </i>
                            ...
                            <div class="bottom-content clearfix">
                               <div class="meta-bed-room">
                                   <i class="fa fa-bed"></i> <a href= "jararesort.php"><strong>View Details</strong></a>
                               </div>
