...
if((isset($_POST['name']) && (!empty($_POST['name']))) && (isset($_POST['email']) && !empty($_POST['email'])) && (isset($_POST['subject']) && !empty($_POST['subject']))){
    ...
    $to = "info@komatecapartments.com";
    $headers = "From : " . $email;
    
    if( mail($to, $subject, $message, $headers)){
       echo "<center><h2><b><font color=green>E-Mail Sent successfully, we will get back to you soon.</font></b></h2></center>";
...
<!-- Mirrored from htmlguru.net/house-rent/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Jul 2022 20:16:04 GMT -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="heading-content-one">
                        <h2 class="title default-text-gradient">Contact us</h2>
                ...
                <div class="col-md-4">
                    <div class="contact-us-content-left">
                        <div class="contact">
                            ...
                            <p>Lagos Lekki Ibeju Lekki, 3/15 Queens Avenue, Museyo  <br>Bolar Bus Stop, Eleko CI, Lagos. </p>
                        </div><!-- /.contact -->
                    
                        <div class="contact">
                            <h4><i class="fa fa-envelope"></i>Mall</h4>
                            <p>info@komatecapartments.com, booking@komatecapartments.com</p>
                        </div><!-- /.contact -->
                
                    
                        <div class="contact">
                            <h4><i class="fa fa-volume-control-phone"></i>Call</h4>
                            <p>+234 813 136 0358</p>
                        </div><!-- /.contact -->
                            ...
                            <div class="row">
                                <!--<div class="col-md-5 col-lg-4">
                                    <div class="form-group">
                                        <select class="selectpicker" data-style="selectcorp" name="gen" id="gen">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row row-lg">
                                        ...
                                        <div class="col-lg-5">
                                            <div class="form-group">
                                                <label class="sr-only" for="name">Subject<br></label>
                                                <div class="inner-addon left-addon">
                                                    <i class="fa fa-pencil"></i>
                                                    <input type="text" class="form-control" placeholder="Subject" name="subject" id="subject" data-name="Subject">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
